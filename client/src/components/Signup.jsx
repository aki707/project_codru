...
function Signup() {
  ...
  const handleEmailVerification = async () => {
    setLoading(false);
    const res = await fetch("https://codru-server.onrender.com/generate-otp", {
      method: "POST",
  ...
  const handleOtpVerification = async (finalValue) => {
    ...
    const res = await fetch("https://codru-server.onrender.com/verify-email", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  const PostData = async (e) => {
    ...
    const res = await fetch("https://codru-server.onrender.com/register", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        name,
