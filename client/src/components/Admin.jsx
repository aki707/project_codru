...
export default function Admin() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await fetch("https://codru-server.onrender.com/users");
        if (!response.ok) {
  ...
  const handleDelete = async (id, username, role) => {
    ...
    try {
      const response = await fetch(`https://codru-server.onrender.com/user/${username}`, {
        method: "DELETE",
        headers: {
  ...
  const handleBro = async (username, isAdmin) => {
    try {
      ...
      const response = await fetch(`https://codru-server.onrender.com/generate-otp-bro`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleOtpVerification = async (username, finalValue) => {
    ...
    const res = await fetch("https://codru-server.onrender.com/verify-bigbro", {
      method: "POST",
