...
const About1 = ({userData, setUserData}) => {
   const [activeId,SetActiveId] = useState("Whoarewe");
        ...
        <div className='about-page'>
            <div className='about-container'>
               <div className='left-headings'>
                <div className={`headings ${activeId === 'Whoarewe' ? 'active' : ''}`} 
                onClick={() => handleClick('Whoarewe')}>
                    Who are we?
                </div>
                <div  className={`headings ${activeId === 'Goals' ? 'active' : ''}`}
                onClick={() => handleClick('Goals')}>
                    Our Goal & Vision
                </div>
                <div  className={`headings ${activeId === 'Founder' ? 'active' : ''}`}
                onClick={() => handleClick('Founder')}>
                    Our Founder : Lavish Sharma
                </div>
               </div>
              ...
              change.
                ...
                {activeId=== 'Founder' && (
                    <div className='Founder'>
                        ...
                        <div className='left'>
                            <img src="https://media.licdn.com/dms/image/v2/D4D03AQHRy_eLKB5D2Q/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1694781404851?e=1752105600&v=beta&t=Sh0QmRJN60WDsn_EsNveMb0mhwECDg3eBYFyqg6_JRA" alt="founder" />
                        <p>
