...
function Commentpage({ onFocus, blogId, userData, setUserData }) {
  ...
  const fetchComments = async () => {
    try {
      const res = await fetch(`https://codru-server.onrender.com/comments/${blogId}`);
      if (!res.ok) {
  ...
  useEffect(() => {
    const updateUserPhoto = async () => {
      try {
        const res = await fetch("https://codru-server.onrender.com/updateUserPhoto", {
          method: "PUT",
  ...
  const Addcomment = async () => {
    try {
      const res = await fetch("https://codru-server.onrender.com/comments", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          blogId: blogId,
  ...
  const deleteComment = async (commentId, blogId) => {
    try {
      const res = await fetch(`https://codru-server.onrender.com/comments/${commentId}`, {
        method: "DELETE",
        headers: {
  ...
  const likeComment = async (commentId) => {
    try {
      const res = await fetch("https://codru-server.onrender.com/comments/like", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const dislikeComment = async (commentId) => {
    try {
      const res = await fetch("https://codru-server.onrender.com/comments/dislike", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({ blogId, commentId, username: currentUser }),
      });
  ...
  const editComment = async (commentId, newText) => {
    try {
      const res = await fetch("https://codru-server.onrender.com/comments/edit", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
