...
const Calendar = () => {
  ...
  const checkAuthorization = async () => {
    try {
      ...
      const response = await fetch('https://codru-backend.onrender.com/calendar/check-auth');
  ...
  const fetchEvents = async () => {
    try {
      const response = await fetch('https://codru-backend.onrender.com/calendar/events');
      if (!response.ok) {
  ...
  const addEvent = async (event) => {
    ...
    try {
      const response = await fetch('https://codru-backend.onrender.com/calendar/add-events', {
        method: 'POST',
        headers: {
  ...
  const removeEvent = async (event) => {
    ...
    try {
      await fetch(`https://codru-backend.onrender.com/calendar/del-events/${event.id}`, {
        method: 'DELETE',
      });
...
//     try {
//       console.log('Checking authorization...');
//       const response = await fetch('http://localhost:3000https://codru-backend.onrender.com/calendar/check-auth');
//       if (!response.ok) {
...
//   const fetchEvents = async () => {
//     try {
//       const response = await fetch('http://localhost:3000https://codru-backend.onrender.com/calendar/events');
//       if (!response.ok) {
//         const errorData = await response.json();
//         throw new Error(errorData.error || 'Failed to fetch events');
//       }
...
//     try {
//       const response = await fetch(`http://localhost:3000https://codru-backend.onrender.com/calendar/events/${event.id}`, {
//         method: 'DELETE',
//       });
